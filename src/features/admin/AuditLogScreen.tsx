 ...
 * - Minh chứng 1: Tại dòng 86 có khai báo `export const AuditLogScreen = () => { ... }`.
 *   Khi Quản trị viên vào màn hình Nhật ký kiểm toán, React khởi tạo Component này trên Virtual DOM.
 * - Minh chứng 2: Tại các dòng 88-96 có khai báo State điều khiển bản ghi đang xem chi tiết (`selectedLog`),
 ...
 * - Minh chứng: Tại dòng 111 khai báo `const formatJsonSafely = (val: string | null) => { ... }`.
 ...
 * - Minh chứng: Tại dòng 133 khai báo `const { data, isLoading } = useQuery(...)`.
 * - Cụ thể tại sao đây là minh chứng?
 ...
 * - Minh chứng: Tại dòng 166 khai báo mảng `columns` cấu hình các cột của Antd Table.
 * - Cụ thể tại sao đây là minh chứng?
 ...
 * - Minh chứng: Tại dòng 209 khối JSX Render hiển thị Header, Card chứa thanh lọc đa tiêu chí, Bảng Antd Table
